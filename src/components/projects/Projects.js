...
export const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "For an academic project, I recreated the puzzle board game, 'Hoppers', using JavaFX and Java following a MVC structure. This application had a restart button, undo button, as well as a hint button. I implemented a BFS solver to make hints possible.",
      imgUrl: projImg2,
